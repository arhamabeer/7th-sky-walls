...
| `test:interaction` | 298 behavioural checks across nine contexts — mobile, tablet, desktop, the Android AR tiers, AR launch-failure recovery, custom wording, Urdu and Arabic, reduced motion and the rate limiter. |
